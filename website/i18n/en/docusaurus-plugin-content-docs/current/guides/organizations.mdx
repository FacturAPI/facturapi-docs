...
If you also need to manage users, invitations, and granular permissions inside
each organization, check the
[Team and roles guide](/docs/guides/team-management).

That workflow can be handled either through the API or directly from the
