...
ya sea desde tu dashboard o usando la API, con el método [Crear Organización](/api#operation/createOrganization),
...
[Centro de Integración](https://www.facturapi.io/dashboard/integration).
:::
