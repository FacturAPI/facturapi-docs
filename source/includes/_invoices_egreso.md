...
**products**<br><small>requerido</small> | array of objects | none | Arreglo de uno o más objetos con detalles del concepto a facturar.
**products[].description**<br><small>requerido</small> | string | none | Resumen de la operación en una sola descripción. Deben mencionarse cada uno de los productos que contempla el descuento, devolución o bonificación aplicada y que contienen las facturas relacionadas. Si el egreso está basado en un pocentaje (como al aplicar un 30% de descuento), dicho porcentaje debe incluirse en la descripción junto al nombre del producto que corresponda.
**products[].price**<br><small>requerido</small> | decimal | none | Suma total de la cantidad devuelta, descontada o bonificada.
**products[].[...]**<br><small>opcional</small> | various | various | Puedes usar las demás propiedades de [Crear Producto](#crear-producto), con la diferencia de que las no mencionadas en esta sección son opcionales y adquirirán el valor recomendado para el comprobante de Egreso.
