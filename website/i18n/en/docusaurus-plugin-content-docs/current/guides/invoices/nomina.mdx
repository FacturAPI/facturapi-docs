...
To fully understand all the available options when creating an invoice, detailed descriptions of each field, and the most commonly used catalogs, please refer to the [Create Invoice API Reference](/api/#operation/createInvoice), and then click on the **Nómina** invoice type.
