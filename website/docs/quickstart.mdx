...
Si tienes dudas sobre este cambio, puedes contactar a nuestro equipo de soporte en [soporte@facturapi.io](mailto:soporte@facturapi.io) o en el chat de nuestra página [www.facturapi.io](https://www.facturapi.io).
...
:::info
  Por default se considera que el precio del producto tiene impuestos incluidos.
...
### 4. Envía la factura por correo electrónico
