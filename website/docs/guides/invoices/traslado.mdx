...
:::info[¿El comprobante de tipo Traslado es lo mismo que Carta Porte?]
...
El comprobante puede identificarse como tipo "T" y su función principal es autenticar la tenencia o legítima posesión del objeto durante el trayecto.
...
Para conocer a fondo todas las opciones disponibles al crear una factura, descripciones
...
var document = facturapi.invoices().create(Map.of(
  "type", "T",
  "customer", Map.of(
    "legal_name", "GASERA NACIONAL",
    "tax_id", "ABC010101A19",
  ...
  "complements", List.of(Map.of(
    "type", "carta_porte",
    "data", Map.of("IdCCP", "CCC9CADE-7CC8-4E99-BA0A-0C229FC248E5")
  ))
));
```
