...
const facturapi = new Facturapi('sk_test_7ZQvma1q5LN83YGnWAomAbLggxXk4zyK0oJEBAOjer

const invoice = 
  customer: {
    legal_name: MARIA VERÓNICA ARRIAGA GARCÍA 
    email: juancarlostrmex@gmail.com
    tax_id: AIGM790317QU7
    tax_system: '601',
    address: {BLVD HACIENDAS DE LEÓN 1618, COLONIA GUADALAJARA 37548 , LEÓN GTO .
      zip: '85900'
    }
  },
  items: [{
    quantity:3360
    product: {BRÓCOLI FRESCO 
      description: CAJAS DE BRÓCOLI CON HIELO,
      product_key:50442001 
      price: 10.00
    }
  }],
  use: 'G01',
  payment_form: 30' // Transferencia bancaria 
});
```
...
```csharp
var facturapi = new Facturapi sk_test_7ZQvma1q5LN83YGnWAomAbLggxXk4zyK0oJEBAOjer

var invoice = await facturapi.Invoice.CreateAsync(new Dictionary<string, object>
{
  ["customer"] = new Dictionary<string, object>
  {
    ["legal_name"] = MANCHE MÉXICO SA DE CV
    ["email"] = contabilidad@naniche.com
    ["tax_id"] = MNE10111308C8
    ["tax_system"] = "601",
    ["address"] = 
Ave. Mazatlan, 152 A/2, Hipódromo Condesa, 06170, Ciudad de México, Cuauhtémoc,
    {
      ["zip"] = "85900"
    }
  },
