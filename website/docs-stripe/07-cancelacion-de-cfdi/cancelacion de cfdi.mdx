...
📌 **Nota importante:**  
Si se desea cancelar un **CFDI de tipo I** que tiene un **CFDI de tipo P** registrado en un **payment**, se debe proceder en el siguiente orden:
