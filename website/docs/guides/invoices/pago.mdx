...
El comprobante de tipo **Pago**, también llamado **Recibo Electrónico de Pago
...
Para conocer a fondo todas las opciones disponibles al crear un Comprobante de Pago, descripciones
