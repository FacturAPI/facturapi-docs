...
### Producto con IVA 16% con impuestos incluidos (default)

Por default, se considera que el precio de un producto tiene impuestos incluidos,
...
var product = facturapi.products().create(Map.of(
  "description", "Ukelele",
  "product_key", "60131324",
  "price", 345.60,
  "sku", "ABC1234"
...
Facturapi facturapi = new Facturapi("sk_test_API_KEY");
var product = facturapi.products().update("PRODUCT_ID", Map.of(
  "description", "Ukelele actualizado",
  "price", 400.90
));
```
