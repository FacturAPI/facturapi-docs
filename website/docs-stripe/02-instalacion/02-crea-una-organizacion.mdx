...
2. **Sube tu certificado CSD** *(opcional por ahora)*  
   Aunque no es obligatorio de inmediato, deberás [Subir tu certificado CSD](https://dashboard.facturapi.io/settings/certs) más adelante para timbrar CFDI correctamente. Una vez agregado, el **RFC se extraerá de tu certificado y asignará automáticamente a tu organización**.
