...
convertir su recibo en factura.
...
## Seleccionar dominio de autofacturación
...
`self_invoice_url` para que contenga una dirección URL que le puedes dar a tu
cliente para que termine de llenar sus datos fiscales y pueda convertir su
recibo en factura.

También puedes instruir a tus clientes visitar `https://factura.space/<DOMAIN>`
y proporcionarles la clave del campo `key` por separado, la cual podrán
introducir en el sitio para acceder a tu recibo.
...
recibo a partir de las configuraciones de recibos "Periodo de facturación"
