...
El **Comprobante de Pago**, también llamado _Recibo Electrónico de Pago (REP)_, _comprobante al que se le
incorpora el complemento de recepción de pagos_, o simplemente _complemento de pago_ se utiliza para
dar constancia fiscal de que la empresa o la persona recibió un pago por una mercancía o servicio entregado
con anterioridad.

Para emitir un Comprobante de Pago, debe existir un Comprobante de Ingreso que se haya creado al momento de
...
[referencia del método Crear Factura](/api/#operation/createInvoice), y posteriormente haz clic sobre
