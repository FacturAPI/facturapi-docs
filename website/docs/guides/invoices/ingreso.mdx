...
El **Comprobante de Ingreso**, también conocido simplemente como _factura_, se utiliza para
dar constancia fiscal de que la empresa o la persona ha entregado una mercancía o un servicio,
