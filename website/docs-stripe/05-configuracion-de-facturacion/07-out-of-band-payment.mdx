...
En las [opciones de configuración](https://dashboard.stripe.com/settings/apps/io.facturapi.stripe-app) de la App de Facturapi, puedes definir la forma de pago que se asignará a los CFDI cuando el pago se realice fuera de Stripe.
