...
Una vez registrado, podrás guardar el `id` del objeto creado y usarlo para
facturar al mismo cliente sin volver a enviar todos sus datos fiscales.
...
[referencia del método Crear Cliente](/api/#operation/createCustomer).
...
<details><summary>Respuesta: Objeto Customer</summary>
...
Para conocer qué otros datos puedes incluir, consulta la
[referencia completa del método Crear Cliente](/api/#operation/createCustomer).
