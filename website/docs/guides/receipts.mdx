...
la información de la venta con el propósito de que pueda facturarse si el cliente lo solicita.

Al crear un **recibo digital** en Facturapi, tus clientes tendrán acceso a un sitio web a donde pdrán
